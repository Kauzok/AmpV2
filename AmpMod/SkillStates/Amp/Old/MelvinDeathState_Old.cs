...
{
    public class MelvinLeap_Old : GenericCharacterDeath
    {
        ...
        public void UnsetOverride()
        {
            ...
            {
                Debug.Log("unsetting");
                this.specialSlot.UnsetSkillOverride(SummonWurm_Old.src, SummonWurm_Old.cancelSkillDef, GenericSkill.SkillOverridePriority.Contextual);
        ...
        public override void OnEnter()
        {
            ...
            if (component)
            {
                ...
                //Util.PlaySound(MelvinLeap_Old.deathSoundString, component.bones[0].gameObject);
            }
            Transform modelTransform = base.GetModelTransform();
            if (modelTransform)
            {
                PrintController printController = modelTransform.gameObject.AddComponent<PrintController>();
                printController.printTime = MelvinLeap_Old.duration;
                ...
                if (component3)
                {
                    ...
                    if (transform)
                    {
                        ...
                        if (component4)
                        {
                            ...
                            component4.maxDuration = MelvinLeap_Old.duration;
                        }
                    }
                }
                if (NetworkServer.active)
                {
                    EffectManager.SimpleMuzzleFlash(MelvinLeap_Old.initialDeathExplosionEffect, base.gameObject, "HeadCenter", true);
                }
            }
        }
        ...
        public override void FixedUpdate()
        {
            ...
            if (NetworkServer.active && this.stopwatch > MelvinLeap_Old.duration)
            {

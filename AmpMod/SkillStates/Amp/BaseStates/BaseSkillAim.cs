...
namespace AmpMod.SkillStates.BaseStates
{
    ...
    public abstract class BaseSkillAim : BaseSkillState
    {
            protected abstract BaseSkillFire GetNextState();
        ...
        public override void FixedUpdate()
            {
               ...
               if (!hasMuzzleEffect)
               {
                ...
                {
                    BaseSkillFire nextState = this.GetNextState();
                ...
                if (this.areaIndicatorInstance)
                    {
                        nextState.aimPosition = this.areaIndicatorInstance.transform.position;
                        nextState.aimRotation = this.areaIndicatorInstance.transform.rotation;
                    }
                    else
                    {
                        nextState.aimPosition = base.transform.position;
                        nextState.aimRotation = this.areaIndicatorInstance.transform.rotation;
                    }
